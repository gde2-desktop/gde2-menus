...
#define gde2_menu_monitor_file_get       menu_get_file_monitor
#define gde2_menu_monitor_directory_get  menu_get_directory_monitor

#define gde2_menu_monitor_ref    menu_monitor_ref
#define gde2_menu_monitor_unref  menu_monitor_unref

#define gde2_menu_monitor_notify_add     menu_monitor_add_notify
#define gde2_menu_monitor_notify_remove  menu_monitor_remove_notify
#define gde2_menu_monitor_notify_ref     menu_monitor_notify_ref /* private */
#define gde2_menu_monitor_notify_unref   menu_monitor_notify_unref /* private */
